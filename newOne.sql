...
--
-- Host: ix-trusty.cs.uoregon.edu    Database: database
-- ------------------------------------------------------
...
CREATE TABLE `Course` (
  ...
  `Group_require` varchar(45) DEFAULT NULL,
  ...
  KEY `Course_to_Group_idx` (`Group_require`),
  CONSTRAINT `Course_to_Group` FOREIGN KEY (`Group_require`) REFERENCES `Group` (`Code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `Course` VALUES (11087,'BI507','Bruce Bowerman','None','Graduate','Yes','4','EMU','M'),(11453,'CIS211','John Conery','SC','Undergraduate','Yes','4','LIL','T'),(11560,'CIS415','Joe Svenek','SC','Bothlevel','No','4','DES','W'),(11571,'CIS451','Chris Wilson','None','Bothlevel','No','4','CHA','R'),(12838,'HIST443','David Luebke','AC','Bothlevel','No','4','STB','F'),(12847,'HIST410','Carlos Aguirre','AL','Bothlevel','No','4','LA','M'),(13733,'MATH256','Huaxin Lin','SC','Undergraduate','No','4','MCK','T'),(13965,'MATH351','Yuan xu','SC','Undergraduate','No','4','FEN','W'),(14678,'PSY607','Jennifer Pfeifer','None','Graduate','No','4','CON','R'),(14865,'PSY201','Ulrich Mayr','SSC','Undergraduate','No','4','KLA','F'),(15346,'CLAS202','Mary Jaeger','AL','Undergraduate','No','4','LIL','R'),(15789,'CLAS110','Christopher Eckerman','IC','Undergraduate','No','2','DES','W'),(17334,'PHYS607','Raymond Frey','None','Graduate','No','4','STB','T'),(17893,'PHYS153','Timothy Jenkins','SC','Undergraduate','No','2','LA','M'),(19456,'ANTH173','Frances White','IC','Undergraduate','No','2','DES','F'),(19692,'AAD510','Jon Erlandson','SSC','Graduate','No','4','EMU','F');
...
INSERT INTO `Department` VALUES ('ANTH','Department of Anthropology','Frances Whites','25'),('BI','Department of Biology','Bruce Bowerman','62'),('CIS','Computer Information and Science','Joe Sventek','26'),('CLAS','Department of Classics','Christopher Eckerman','10'),('HIST','Department of History','David Luebke','33'),('MATH','Department of Mathmatics','Yuan Xu','61'),('PHYS','Department of Physics','Raymond Frey','35'),('PSY','Department of Psychology','Ulrich Mayr','32');
...
-- Dump completed on 2015-12-10  3:50:35
